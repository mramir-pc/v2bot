...
# 			else
			...
			sleep 1
   			...
   			db_namewizwiz=$(cat /var/www/html/v2bot/baseInfo.php | grep '$dbName' | cut -d"'" -f2)
		      	db_userwizwiz=$(cat /var/www/html/v2bot/baseInfo.php | grep '$dbUserName' | cut -d"'" -f2)
		      	db_passwizwiz=$(cat /var/www/html/v2bot/baseInfo.php | grep '$dbPassword' | cut -d"'" -f2)
			...
			rm /var/www/html/v2bot/updateShareConfig.php
			rm /var/www/html/v2bot/README.md
			rm /var/www/html/v2bot/README-fa.md
			rm /var/www/html/v2bot/LICENSE
			rm /var/www/html/v2bot/update.sh
			rm /var/www/html/v2bot/wizwiz.sh
  			rm /var/www/html/v2bot/tempCookie.txt
  			rm /var/www/html/v2bot/settings/messagewizwiz.json
			clear
...
# 			fi
		...
		"Backup")
			...
			wget https://raw.githubusercontent.com/mramir-pc/v2bot/main/dbbackupwizwiz.sh | chmod +x dbbackupwizwiz.sh
			./dbbackupwizwiz.sh
