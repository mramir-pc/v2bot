...
██ ███ ██ ██  ███    ██ ███ ██ ██  ███         ██ ██  ██    ██ ██ 
 ███ ███  ██ ███████  ███ ███  ██ ███████     ██   ██  ██████  ██ 
\033[0m"
echo -e "    \e[31mTelegram Channel: \e[34m@\033[0m | \e[31mTelegram Group: \e[34m@mramir-pc\033[0m\n"
...
(crontab -l ; echo "*/3 * * * * curl https://${DOMAIN_NAME}/v2bot/settings/tronChecker.php >/dev/null 2>&1") | sort - | uniq - | crontab -
